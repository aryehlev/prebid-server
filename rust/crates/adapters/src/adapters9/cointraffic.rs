...
pub struct CointrafficAdapter { pub endpoint: String }
impl CointrafficAdapter { pub fn new(endpoint: String) -> Self { Self { endpoint } } }

impl Bidder for CointrafficAdapter {
